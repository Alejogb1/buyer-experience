    ...
    return(
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6" id="planes">
            ...
            <div className="space-y-8 lg:grid lg:grid-cols-2 sm:gap-2 xl:gap-6 lg:space-y-0 max-w-2xl m-auto">
                <div className="flex flex-col p-6 mx-auto max-w-xs text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow border-gray-600 xl:p-8 bg-gray-800 text-white">
